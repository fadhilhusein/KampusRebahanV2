      ...
      <main className="flex-1 pt-24 pb-16 px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 text-[14px] leading-relaxed text-foreground/70">
            ...
            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">1. Penerimaan Syarat</h2>
            ...
            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">2. Layanan</h2>
            ...
            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">3. Pembayaran</h2>
            ...
            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">4. Saldo Akun</h2>
              <ul className="list-disc list-inside space-y-2">
            ...
            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">5. Pengiriman Produk</h2>
            ...
            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">6. Garansi & Refund</h2>
              <ul className="list-disc list-inside space-y-2">
            ...
            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">7. Larangan Penggunaan</h2>
            ...
            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">8. Pembatasan Tanggung Jawab</h2>
            ...
            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">9. Perubahan Syarat</h2>
            ...
            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">10. Kontak</h2>
