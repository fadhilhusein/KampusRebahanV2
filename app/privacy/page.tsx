    ...
    <>
      ...
      <main className="flex-1 pt-24 pb-16 px-8">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-[36px] font-semibold text-foreground tracking-tight mb-2">
            Kebijakan Privasi
          </h1>
          <p className="text-[13px] text-foreground/30 mb-10">Terakhir diperbarui: Mei 2026</p>

          <div className="space-y-8 text-[14px] leading-relaxed text-foreground/70">

            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">1. Informasi yang Kami Kumpulkan</h2>
              <p>Kami mengumpulkan informasi berikut saat Anda menggunakan layanan KampusRebahan:</p>
              <ul className="list-disc list-inside space-y-2 mt-2">
                <li><strong className="text-foreground/80">Data Akun:</strong> Nama, alamat email, dan password terenkripsi saat registrasi.</li>
                <li><strong className="text-foreground/80">Data Transaksi:</strong> Riwayat order, nominal pembayaran, dan referensi transfer.</li>
                <li><strong className="text-foreground/80">Data Teknis:</strong> Informasi perangkat dan browser untuk keamanan sesi.</li>
              </ul>
            </section>

            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">2. Penggunaan Informasi</h2>
            ...
            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">3. Keamanan Data</h2>
            ...
            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">4. Berbagi Data dengan Pihak Ketiga</h2>
              <p>Kami tidak menjual atau menyewakan data pribadi Anda kepada pihak ketiga. Data hanya dibagikan kepada:</p>
              <ul className="list-disc list-inside space-y-2 mt-2">
                <li><strong className="text-foreground/80">Mitra penyedia produk</strong> (hanya data yang diperlukan untuk fulfillment order).</li>
                <li><strong className="text-foreground/80">Penyedia infrastruktur</strong> (database cloud) dengan standar keamanan tinggi.</li>
              </ul>
            </section>

            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">5. Penyimpanan Data</h2>
            ...
            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">6. Cookie & Sesi</h2>
            ...
            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">7. Hak Anda</h2>
            ...
            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">8. Perubahan Kebijakan</h2>
            ...
            <section>
              <h2 className="text-[16px] font-semibold text-foreground mb-3">9. Kontak</h2>
